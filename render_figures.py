...
if __name__ == '__main__':
    ...
    try:
        p = figure(x_axis_label='Training steps', y_axis_label='1 - R^2', width=500, height=300, x_range=(10, 1e4), x_axis_type='log', y_axis_type='log')
    ...
    try:
        ...
        p = figure(x_axis_label='Regularization strength', y_axis_label='1 - R^2', width=500, height=300, y_axis_type='log')
    ...
    try:
        p = figure(x_axis_label='Training steps', y_axis_label='1 - R^2', width=500, height=300, y_axis_type='log')
    ...
    try:
        p = figure(x_axis_label='Dataset size', y_axis_label='1 - R^2', width=500, height=300, x_axis_type='log', y_axis_type='log', y_range=(0.3,2.))
    ...
    try:
        p = figure(x_axis_label='Dataset size', y_axis_label='1 - R^2', width=500, height=300, x_axis_type='log', y_axis_type='log', y_range=(.3,2))
    ...
    try:
        p = figure(x_axis_label='Dataset size', y_axis_label='1 - R^2', width=500, height=300, x_axis_type='log', y_axis_type='log', y_range=(.1,2.))
    ...
    try:
        p = figure(x_axis_label='Training steps', y_axis_label='1 - R^2', width=500, height=300, x_axis_type='log', y_axis_type='log', x_range=(10,10000), y_range=(.2,4.))
