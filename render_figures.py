...
if __name__ == '__main__':
    ...
    try:
        p = figure(title="Linear regression", x_axis_label='Dataset size', y_axis_label='R^2', height=300, x_axis_type='log')
    ...
    try:
        p = figure(title="Linear vs. nonlinear regression", x_axis_label='Dataset size', y_axis_label='R^2', height=300, x_axis_type='log')
